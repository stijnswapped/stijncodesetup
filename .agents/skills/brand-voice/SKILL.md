...
5. If site copy matters, include the current SCS landing page and repo/plugin framing.
...
If the user wants Affaan / SCS voice and live sources are thin, start here unless newer source material overrides it:
