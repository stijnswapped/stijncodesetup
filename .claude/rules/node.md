# Node.js Rules for stijncodesetup
...
> Project-specific rules for the SCS codebase. Extends common rules.
...
- Use `run-with-flags.js` wrapper for all hooks so `SCS_HOOK_PROFILE` and `SCS_DISABLED_HOOKS` runtime gating works
