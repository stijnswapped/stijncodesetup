---
name: stijncodesetup-conventions
description: Development conventions and patterns for stijncodesetup. JavaScript project with conventional commits.
---

# StijnCodeSetup Conventions

> Generated from [StijnCodeSetup/stijncodesetup](https://github.com/StijnCodeSetup/stijncodesetup) on 2026-03-20

## Overview

This skill teaches Claude the development patterns and conventions used in stijncodesetup.
...
```text
fix: auto-detect SCS root from plugin cache when CLAUDE_PLUGIN_ROOT is unset (#547) (#691)
```
...
*This skill was auto-generated by [SCS Tools](https://scs.tools). Review and customize as needed for your team.*
