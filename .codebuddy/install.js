#!/usr/bin/env node
/**
 * SCS CodeBuddy Installer (Cross-platform Node.js version)
...
function doInstall() {
  ...
  console.log('SCS CodeBuddy Installer');
  console.log('=======================');
  console.log('');
  ...
  // Add manifest itself
  ensureManifestEntry(manifest, '.scs-manifest');
  ...
  console.log('  3. Enjoy the SCS workflows!');
  console.log('');
