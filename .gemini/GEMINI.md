...
This file provides Gemini CLI with the baseline SCS workflow, review standards, and security checks for repositories that install the Gemini target.

## Overview

StijnCodeSetup (SCS) is a cross-harness coding system with 36 specialized agents, 142 skills, and 68 commands.
