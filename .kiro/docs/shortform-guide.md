...
git clone https://github.com/yourusername/scs-kiro-public-repo.git
cd scs-kiro-public-repo
...
- **Migration Guide**: `docs/migration-from-scs.md` - For Claude Code users
