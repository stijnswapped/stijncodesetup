...
The script audits the current working directory by default and auto-detects whether the target is the SCS repo itself or a consumer project using SCS.
...
6. Suggested SCS skills to apply next.
