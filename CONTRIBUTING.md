# Contributing to StijnCodeSetup
...
- rename the skill when SCS materially changes or expands the surface
- prefer SCS-native rules, skills, scripts, and MCPs over new default third-party dependencies
...
SCS ships skill subsets for other harnesses:
