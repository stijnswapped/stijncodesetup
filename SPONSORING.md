...
SCS is maintained as an open-source agent harness operating system across Claude Code, Cursor, OpenCode, Codex, Gemini, Zed, and other agent workflows.
...
- npm downloads (`stijncodesetup`, `scs-agentshield`)
...
- Project site: [https://scs.tools](https://scs.tools)
