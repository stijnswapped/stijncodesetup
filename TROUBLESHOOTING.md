...
Common issues and solutions for StijnCodeSetup (SCS) plugin.
...
**Solutions:**
```bash
# First inspect what SCS still knows about this machine
scs list-installed
scs doctor
scs repair
...
# If the issue is marketplace/account access, use SCS Tools billing/account recovery separately; do not use reinstall as a proxy for account recovery
