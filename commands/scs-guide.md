---
description: Navigate SCS's current agents, skills, commands, hooks, install profiles, and docs from the live repository surface.
---

# /scs-guide

Use this command as a conversational map of StijnCodeSetup. It should help the user discover the right SCS surface for their task without dumping the entire README or stale catalog counts.
...
/scs-guide hooks
/scs-guide install
/scs-guide find: <query>
/scs-guide <feature-or-file-name>
```
...
- `scripts/ci/catalog.js --json` for live catalog counts when running inside SCS
...
- `/project-init` for stack-aware SCS onboarding of a target project
