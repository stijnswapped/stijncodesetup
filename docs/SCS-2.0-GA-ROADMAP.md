...
<https://linear.app/itomarkets/project/scs-platform-roadmap-52b328ee03e1>
...
[`docs/releases/2.0.0/scs-2-hypergrowth-release-command-center.md`](releases/2.0.0/scs-2-hypergrowth-release-command-center.md).
It is the operator surface for the final SCS 2.0 repo identity, video suite,
...
- The tracked platform audit is still green on May 20 with 0 open PRs,
  ...
  0 conflicting PRs, and 0 blocking dirty files across `StijnCodeSetup/StijnCodeSetup`,
  `StijnCodeSetup/agentshield`, `StijnCodeSetup/JARVIS`, `SCS-Tools/SCS-Tools`, and
  `SCS-Tools/SCS-website`.
- The new #2015 setup-location Q&A was answered and marked accepted. The
  ...
  normal workspace, install the `scs@scs` Claude plugin once, copy only needed
  rule folders when using manual rules, and avoid stacking plugin plus full
  manual install.
- SCS-Tools PRs #80-#88 landed the next hosted-platform batch: runtime
...
- SCS PR #2019 merged the Marketplace Pro selected-target release-gate sync
...
- SCS PR #2020 merged the selected-target announcement-gate mirror as
...
- SCS-Tools PR #90 added the selected-target official announcement gate for
...
- SCS-Tools PR #91 added `--env-file` support to both billing gate scripts so
  ...
  merge.
- SCS-Tools PR #92 added a non-breaking `INTERNAL_OPERATOR_API_SECRET` bearer
  ...
  Worker was deployed to `api.scs.tools`.
...
- SCS-Tools PR #93 recorded that live billing evidence in the app launch
...
- Linear ITO-54 and the SCS Platform Roadmap now have the May 20 SCS-Tools
...
- Linear ITO-61 and the SCS Platform Roadmap now have the May 20 Marketplace
  Pro release-gate comments `467d148a-712a-4777-aad9-95593e9f1739` and
  `7642ee9c-3107-400c-a229-53e2895a8914`, recording SCS-Tools #89, SCS #2019,
  the green post-merge CI run, and the remaining internal bearer-token gate.
  The repo mirror now also records SCS-Tools #90 and #91 as the selected-target
  announcement gate and billing gate env-file operator-path follow-up.

## 2026-05-19 Delta

- The public repo identity is now `StijnCodeSetup/StijnCodeSetup`; release, package, plugin,
...
- The late May 19 queue drain added the deterministic `release:approval-gate`
  on SCS `main`, merged SCS-Tools billing-announcement redaction hardening, and
  ...
  gated.
- The SCS 2.0 release story should lead with the product shape directly:
  harness-native operator system, reusable skills/rules/hooks/MCP conventions,
  `scs2/` alpha control plane, Hermes as optional operator shell, and SCS Tools
...
- GitHub queues are clean across `StijnCodeSetup/StijnCodeSetup`,
  `StijnCodeSetup/agentshield`, `StijnCodeSetup/JARVIS`, `SCS-Tools/SCS-Tools`, and
  `SCS-Tools/SCS-website`: the latest `platform-audit` sweep found 0 open PRs,
...
- Owner-wide queue cleanup is also inside the requested budget:
  ...
  outreach, or placeholder issues. The broader `StijnCodeSetup` owner namespace is
...
- GitHub discussions are current across those tracked repos:
  `StijnCodeSetup/StijnCodeSetup` has 60 total discussions and 0 without
  ...
  JARVIS, SCS Tools, and the SCS Tools website have discussions disabled or 0
...
- The current Linear roadmap contains 16 issue lanes (`ITO-44` through
  `ITO-59`) and five milestones: Security and Access Baseline, SCS 2.0 Preview
  and Publication, AgentShield Enterprise Iteration, SCS Tools Next-Level
  Platform, and Legacy Audit and Salvage.
- Linear live sync is current for the May 19 PR #2002 merge and discussion
  batch: the SCS platform project has the post-PR #2002 sync document
  `scs-may-19-post-pr-2002-sync-64cef8f668e0`, project comment
...
- The latest May 18 merge batch on `main` includes PR #1970 workflow-security
  ...
  OpenAI/AstraFlow provider response guards, SCS-Tools Wrangler OAuth billing
...
- `docs/releases/2.0.0-rc.1/publication-evidence-2026-05-19.md` records the
  current May 19 queue-zero state, canonical SCS identity merge, release video
  ...
  SCS-Tools PR #79 billing-announcement redaction hardening and JARVIS PR #15
  ...
  `scs-may-19-late-queue-zero-and-release-gate-sync-1c26f65e6b3f`, plus project
...
- The May 20 SCS-Tools hosted-platform pass extends that evidence with PR #80
  ...
  (89/89), typecheck, lint, full SCS-Tools Vitest suite (683/683), and
  ...
  typecheck, lint, the full SCS-Tools Vitest suite (686/686), and
  `git diff --check`.
...
- `docs/releases/2.0.0-rc.1/operator-readiness-dashboard-2026-05-20.md`
  ...
  packet; publication, plugin, billing, AgentShield, SCS Tools, Linear release
...
- `docs/releases/2.0.0-rc.1/publication-evidence-2026-05-16.md` records the
  queue, discussion, Linear roadmap, SCS Tools access, Mini Shai-Hulud/TanStack
  ...
  promotion, SCS-Tools #75 billing-gate tightening,
  SCS-Tools #76 AgentShield fleet-summary consumption, SCS-Tools #77 hosted
  finding evidence paths, SCS-Tools #78 harness policy-route linking, PR #1947
...
- SCS-Tools PR #53 merged as `99018e943d03f024de8c9d278c91f66393d4f1ee`
  and added npm registry signature verification before the existing production
  dependency audit in CI.
- SCS-Tools PR #54 merged as `05df89721f49c1e19d8502c545e26f5694806998`
  and made `/scs-tools followups sync-linear` track copy-ready PR drafts in
...
- SCS-Tools PR #55 merged as `5d8c112cce4794cfa089d5b0ea661ba87a178be1`
  and added analysis-depth readiness to `/scs-tools analyze` comments,
...
- SCS-Tools PR #56 merged as `5b729c88641eafe80f65364bab3fc74d0270f57b`
...
- SCS-Tools PR #57 merged as `4cc61112a4cc9feec7b07af09321f360e34af6a4`
...
- SCS-Tools PR #58 merged as `ce09dd8d9b46f65c6b88dc4f48cfb6b6227ae0bf`
  ...
  findings and next actions, and charges usage only after successful execution.
- SCS-Tools PR #59 merged as `505b372dbd8f75f996d9e2ed079effd30cec5ba5`
...
- SCS-Tools PR #60 merged as `b75e0a49ba5672b1ec9a2a4880ddcfa2d07dc557`
  ...
  findings and next actions, and charges usage only after successful execution.
- SCS-Tools PR #61 merged as `7b01b67cae0b80774b311cb515b7eca0aa038c65`
...
- SCS-Tools PR #62 merged as `781d6733e56f7556edb43fb96bdfb00b1f0a3aa6`
  ...
  findings and next actions, and charges usage only after successful execution.
- SCS-Tools PR #63 merged as `fb9e4c5ceb9ccde50da74c7a69c3fa4bd321fc07`
  and made the hosted execution plan operator-visible on queued PR analysis:
  the queue now publishes a non-blocking `SCS Tools / Hosted Depth Plan`
...
- SCS-Tools PR #64 merged as `72020ef94db94840812977ea7ac37e9344036668`
  and added PR-facing hosted job dispatch controls:
  `/scs-tools analyze --job ...` comments now queue hosted jobs against the
  ...
  analysis.
- SCS-Tools PR #65 merged as `bacd4adf6a3a629e8d403865456d15f127baaf4e`
  ...
  actions.
- SCS-Tools PR #66 merged as `4e1db48252d068ea5dcf4308b0bc11b0dfe0c9ce`
  and added a read-only hosted status command:
  `/scs-tools analyze --job status` now reads the #65 latest-result cache for
...
- SCS-Tools PR #67 merged as `f20e6bec2b0bf49e4cc36e08b7285c795973b73d`
  ...
  `SCS Tools / Hosted Depth Plan`, includes the latest hosted run status in
  the plan table, and recommends the next unrun ready job before reruns.
- SCS-Tools PR #68 merged as `2cde524b5ef8f34ab7bb1af973248fe4be4359f8`
  and added deterministic hosted promotion readiness:
  opened/synchronized PRs now publish a non-blocking
  `SCS Tools / Hosted Promotion Readiness` check-run that compares changed
...
- SCS-Tools PR #69 merged as `d0112dac7cef807ae27def41f057682ef0772cce`
...
- SCS-Tools PR #70 merged as `7001d805ac981fe220b4575159f469fbea9dbb76`
  ...
  changed paths alone.
- SCS-Tools PR #71 merged as `d41e59ff00fe1bd0b0c96386e56bc5269d7b9c15`
...
- SCS-Tools PR #72 merged as `973bc51e5436dd279ae5a890cce9811485eef0b5`
...
- SCS-Tools commit `05d4e8296e37ba72e471beaa23ea4c81eb2aa31f`
  ...
  provider output.
- SCS-Tools PR #73 merged as `7d0538c9354e18adbfc72ef00d858949a817fa48`
...
- SCS-Tools commit `91a441b92342b842832ac28b018ee46f0c4a906f`
...
- SCS-Tools commit `eb6941290b2fa70db01a51084e9e79a160238468`
...
- SCS-Tools commit `95d0bec69dbcf364ed084e983a40d0a94d443d16`
...
- SCS-Tools commit `285967807ea7b5eb3146bc984fb2229db67d4290`
...
- SCS-Tools commit `42653f9140c232961280d961ed76a6142433cfa1`
  ...
  announcement gate pass.
- SCS-Tools commit `632e059e51b6e1297ba118807c8b5b2adbac74ce`
...
- SCS-Tools commit `d5f60db` adds sanitized Marketplace-source provenance
...
- SCS-Tools commit `13cd3fc` normalizes billing-state key casing so
...
- SCS-Tools commit `69ca535` surfaces hosted team-learning feedback controls:
...
- SCS-Tools commit `e56fc1a` updates the lockfile for
...
- SCS-Tools PR #89 merged as `512bca6b99cdaa67058a6aa9a4e7e7f0b1d9873a`
  and adds
...
- SCS-Tools PR #91 merged as `72119a1acc6f5a0cd3bb5d90afd6e87fd1fefd05`
...
- SCS-Tools PR #92 merged as `18d80197be779619283e0b37e2952bac53819a07` after
  ...
  the merged Worker was deployed to `api.scs.tools` before the live gate run.
- SCS-Tools PR #93 merged as `d3d62df83fa075660fa4530c3e0edc311a4355fe` after
...
- Handoff `scs-supply-chain-audit-20260513-0645.md` under
  ...
  active npm lockfiles; `cargo audit` clean for `scs2`; trunk `pip-audit`
...
- `docs/releases/2.0.0-rc.1/naming-and-publication-matrix.md` records the
  rc.1 naming decision: ship as StijnCodeSetup (SCS), keep
  `stijncodesetup` for npm, keep `scs` for Claude/Codex plugin slugs, and defer
...
- `docs/releases/2.0.0-rc.1/publication-evidence-2026-05-13.md` records the
  ...
  release-surface and npm publish-surface tests, and 462/462 `scs2` Rust tests.
- `docs/releases/2.0.0-rc.1/publication-evidence-2026-05-13-post-hardening.md`
  ...
  npm publish-surface tests, 462/462 `scs2` Rust tests, npm audit/signature
...
- A detached clean worktree at
  ...
  install, enabled plugin listing, and clean uninstall for `scs@scs`
  `2.0.0-rc.1`.
...
- `docs/architecture/agentshield-enterprise-research-roadmap.md` identifies
  ...
  and SCS-Tools/GitHub App integration.
- SCS PR #1778 recovered the useful stale #1413 network/homelab architect-agent
  concepts.
- SCS-Tools PR #26 added cost/token-risk predictive follow-ups for AI routing,
...
- SCS-Tools PR #27 added the non-blocking `SCS Tools / PR Risk Taxonomy`
...
- SCS-Tools PR #28 added billing readiness audit checks for plan limits,
  entitlements, Marketplace plan shape, subscription source, seats, and
  overage metering.
- SCS-Tools PR #29 added deterministic Reference Set Validation signals for
  analyzer, skill, agent, command, and harness-guidance changes that lack eval,
  golden trace, benchmark, or reference-set evidence.
- SCS-Tools PR #30 capped follow-up generation to three new GitHub issues and
...
- SCS-Tools PR #31 added review follow-up signals to analysis completion
...
- SCS-Tools PR #32 added CI failure-mode predictive follow-ups for workflow
...
- SCS-Tools PR #33 added harness-config quality predictive follow-ups for MCP,
  ...
  evidence.
- SCS-Tools PR #34 added skill-quality predictive follow-ups and a Skill
...
- SCS-Tools PR #35 added RAG/evaluator predictive follow-ups and a
...
- SCS-Tools PR #36 added deep-analyzer predictive follow-ups, a Deep Analyzer
  Evidence PR-risk bucket, and a Linear-ready project sync backlog table for
  deferred follow-up work.
- SCS-Tools PR #37 added a maintained analyzer corpus fixture, corpus validation
...
- SCS-Tools PR #38 added PR review/stale-salvage predictive follow-ups, a
...
- SCS-Tools PR #39 added opt-in native Linear GraphQL sync for deferred
  ...
  configured.
- SCS-Tools PR #40 added a checked-in evaluator/RAG corpus contract covering
...
- SCS-Tools PR #41 hardened supply-chain dependencies.
- SCS-Tools PR #42 added AgentShield evidence-pack gap prediction and routed
...
- SCS-Tools PR #43 recognized the concrete AgentShield #67 evidence-pack
...
- SCS-Tools PR #55 added the first hosted/deeper-analysis readiness signal:
...
- SCS-Tools PR #56 turned that signal into a hosted execution-plan contract:
...
- SCS-Tools PR #57 implemented the first job-specific hosted executor:
...
- SCS-Tools PR #58 implemented the second job-specific hosted executor:
  ...
  scanner artifacts.
- SCS-Tools PR #59 implemented the third job-specific hosted executor:
...
- SCS-Tools PR #60 implemented the fourth job-specific hosted executor:
  ...
  fetches.
- SCS-Tools PR #61 implemented the fifth job-specific hosted executor:
...
- SCS-Tools PR #62 implemented the sixth job-specific hosted executor:
  ...
  secret-bearing path fetches.
- SCS-Tools PR #63 publishes the hosted depth-plan check-run after queued PR
...
- SCS-Tools PR #64 wires those commands into the queue: maintainers can comment
  `/scs-tools analyze --job ci-diagnostics`, `security-evidence`,
...
- SCS-Tools PR #65 persists completed and blocked hosted job results to the
  analysis cache for 30 days and publishes non-blocking `SCS Tools / Hosted
  Job: ...` check-runs so maintainers can scan hosted outcomes from the PR
  checks surface instead of rereading older comments.
- SCS-Tools PR #66 exposes the cached results from PR comments with
  `/scs-tools analyze --job status`, summarizing completed, blocked, and
  not-yet-run hosted jobs for the PR head and recommending the next hosted job
  command.
- SCS-Tools PR #67 feeds those cached results back into the hosted depth-plan
...
- SCS-Tools PR #68 adds the first evaluator-backed hosted promotion gate:
...
- SCS-Tools PR #69 extends that gate to score cached completed hosted job
...
- SCS-Tools PR #76 consumes AgentShield PR #89 fleet output in hosted security
...
- SCS-Tools PR #77 merged as `31fd883b3f0cee135aee4839b01d34855b7867f6`
  ...
  artifact.
- SCS-Tools PR #78 merged as `0d4eb949aa56f56da88e6654273a22ffb95983a1`
...
- SCS-Tools PR #79 merged as `67ee247ae1b7b50ecc1261ed5d62d65cc8390da8`
...
- SCS-Tools PR #80 merged as `4efc8cc858022f84c844690f3298633b081c4398`
  and requires runtime receipt failure reasons before harness runtime receipts
  can count as hosted observability evidence.
- SCS-Tools PR #81 merged as `1fbf635f492284f75ba7166c029c39eb8cc15794`
...
- SCS-Tools PR #82 merged as `7a7b4d096a176ae80b3a2076c09d45601e36013a`
...
- SCS-Tools PR #83 merged as `b6b107f33961bef18a85fb619f3a976eb5d752dd`
  ...
  `/scs-tools followups sync-linear` runs.
- SCS-Tools PR #84 merged as `73bac7058071c55cb30c6b8ac6db779b3660c02c`
...
- SCS-Tools PR #85 merged as `1637e0f2bfa0a889387f2c20675680ccc5528123`
...
- SCS-Tools PR #86 merged as `5a9e94d3ff860307c3e7fd9fd065f0de2bd633dd`
  and reads recent hosted observability events in
  `/scs-tools analyze --job status`, so status comments show budget snapshots,
  blocked results, and budget-blocked outcomes alongside latest job runs.
- SCS-Tools PR #87 merged as `508fbc02b63cf1fcb5af2f3624608fa66e53b5d4`
...
- SCS-Tools PR #88 merged as `c836ac3fb24ed7e2ae38cd61e41c9651ac9c00f8`
...
- SCS PR #1803 landed the contributor Quarkus handling branch after maintainer
...
- SCS PR #1812 salvaged useful Django reviewer, Django build resolver, and
...
- SCS PR #1813 expanded the stale PR salvage ledger with source-to-salvage
...
- SCS PR #1815 salvaged the useful stale #1304 cost-tracking and #1232
  skill-scout work into current command/skill conventions with current catalog
  sync and full local/remote validation.
- SCS PR #1816 salvaged the useful stale #1659 frontend design guidance into
  canonical SCS skill layout while preserving the guardrail that the official
  Anthropic `frontend-design` skill remains externally sourced.
- SCS PR #1817 salvaged the useful stale #1658 code-reviewer false-positive
  guardrails, adding proof gates for HIGH/CRITICAL findings, common
  false-positive exclusions, and a regression test.
- SCS PR #1818 recorded the May 12 stale-salvage gap pass, classifying already
...
| --- | --- | --- | --- |
| Keep public PRs below 20 | Repo-family PR recheck | 0 open PRs across `SCS`, AgentShield, JARVIS, `SCS-Tools/SCS-Tools`, and `SCS-Tools/SCS-website` on the late 2026-05-19 platform audit after merging SCS PR #2013, SCS-Tools PR #79, JARVIS PR #15, and JARVIS PR #16 | Complete |
| Keep public issues below 20 | Repo-family issue recheck | 0 open issues across `SCS`, AgentShield, JARVIS, `SCS-Tools/SCS-Tools`, and `SCS-Tools/SCS-website` on 2026-05-19 after the live platform audit refresh | Complete |
...
| Manage PR discussions | PR review/comment closure plus merge/close state | SCS #1990-#2013 merged through the harness audit, canonical identity, release video suite, growth outreach, evidence refresh, visual QA, suite-count, owner-approval packet, owner-approval dashboard gate, Linear readiness evidence, supply-chain evidence gate, per-project Claude Code adapter, continuous-learning project-registry hygiene, GateGuard quoted git introspection, and deterministic release-approval gate batch; SCS-Tools #79 and JARVIS #15/#16 also merged; no open tracked PRs remain | Complete |
...
| Realtime Linear sync | Project documents/comments plus issue comments for lane updates | SCS-Tools #39 implements opt-in Linear API sync for deferred follow-up backlog items, and SCS-Tools #54 adds copy-ready PR drafts to that backlog when draft PR shells are not opened; `docs/architecture/progress-sync-contract.md` defines the local file-backed realtime boundary; May 18 and May 19 live connector comments were posted to the SCS platform project and lane issues after project status updates returned disabled | Needs workspace config/product rollout for hosted issue sync |
...
The output of this reference work should be concrete SCS deltas, not a second
strategy memo.
...
- Team and individual setups can be scored and improved without blindly
  mutating configs.
- RAG/reference-set design covers vetted SCS patterns, team history, CI
...
### 6. SCS Tools Billing, Deep Analysis, PR Checks, And Linear Sync
...
- Evaluator/RAG corpus contract mirrors the local prototype scenarios into
  SCS-Tools fixtures and tests for stale-PR salvage, billing readiness,
...
- Linear/project backlog sync includes copy-ready PR drafts when
  `/scs-tools followups sync-linear` is used without `open-pr-drafts`, so
...
1. Continue the AgentShield enterprise control-plane sequence from
   ...
   summary/routing across multiple inspected bundles; SCS-Tools PRs #42/#43 now
   route and recognize evidence packs; SCS-Tools PR #76 consumes fleet
   summaries in hosted security review; SCS-Tools PR #77 surfaces source
   evidence paths in hosted PR comments and check-runs; SCS-Tools PR #78
   ...
   review items, SCS-Tools commit `8658951` consumes those outputs in hosted
   security review and Hosted Promotion Readiness scoring, and SCS-Tools
   ...
   SCS-Tools commit `05d4e82` adds hosted promotion judge audit traces with
   deterministic request fingerprints and allowed-citation counts, without
   exposing raw provider output.
   SCS-Tools commit `91a441b` adds a billing announcement preflight command
   for checking Marketplace readback inputs before privileged API calls.
   SCS-Tools commit `2859678` requires Marketplace webhook provenance in
   billing-state before native-payments announcement readiness can pass.
   SCS-Tools commit `42653f9` adds Wrangler OAuth KV readback and confirms the
   ...
   SCS-Tools commit `632e059` adds sanitized target-account readback, and PRs
   ...
   SCS-Tools PR #79 redacts the billing announcement gate account output;
...
2. Run `npm run billing:announcement-gate -- --preflight
   --select-ready-target`, adding `--env-file /path/to/scs-tools.env` when the
...
4. Use the SCS-Tools evaluator/RAG corpus as the promotion gate before adding
