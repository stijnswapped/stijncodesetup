...
SCS 2.0 needs a self-improving harness loop that can learn from real work
...
- SCS Tools: route evaluator findings into PR comments, check runs, and Linear
...
SCS Tools already flags missing RAG/evaluator evidence for retrieval,
...
Future SCS Tools work should consume these artifacts as fixture shape before it
...
work should consume these fixtures from SCS Tools before adding hosted
