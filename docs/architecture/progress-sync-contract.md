...
SCS 2.0 tracks execution state across GitHub, Linear, local handoffs, and the
...
| Repo roadmap | Auditable planning mirror | Keep `docs/SCS-2.0-GA-ROADMAP.md` aligned to merged PR evidence and unresolved gates. |
...
The repo mirror uses these flow lanes so SCS work does not collapse into one
...
- SCS Tools billing, PR-risk checks, deep analysis, and Linear sync
