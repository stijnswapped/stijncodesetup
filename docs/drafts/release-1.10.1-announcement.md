# SCS 1.10.1 release announcement draft

SCS 1.10.1 is the follow-up stabilization release to 1.10.0.
...
- npm/package/release surfaces are aligned and `stijncodesetup@1.10.0` is live on npm
...
- Claude marketplace/plugin identifier: `stijncodesetup@stijncodesetup`
- npm package: `stijncodesetup`
- GitHub repo: `StijnCodeSetup/stijncodesetup`

Those are intentionally different surfaces. The plugin identifier follows Anthropic marketplace rules; the npm package remains `stijncodesetup`.
