...
- renombra la skill cuando SCS cambie o amplíe materialmente la superficie
- prefiere reglas, skills, scripts y MCPs nativos de SCS sobre nuevas dependencias de terceros por defecto
...
SCS incluye subconjuntos de skills para otros harnesses:
