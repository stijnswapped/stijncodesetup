...
Si descubres una vulnerabilidad de seguridad en SCS, por favor repórtala de forma responsable.

**No abras un issue público de GitHub para vulnerabilidades de seguridad.**

En cambio, envía un correo a **<security@scs.tools>** con:
...
- El plugin de SCS y todos los scripts de este repositorio
- Scripts de hooks que se ejecutan en tu máquina
- Scripts del ciclo de vida de instalación/desinstalación/reparación
- Configuraciones de MCP incluidas con SCS
- El escáner de seguridad AgentShield ([github.com/StijnCodeSetup/scs-agentshield](https://github.com/StijnCodeSetup/scs-agentshield))
...
SCS se ejecuta dentro de Claude Code, que inyecta **recordatorios efímeros del lado del cliente** en la entrada del modelo en cada turno (recordatorios de TodoWrite, avisos de cambio de fecha, avisos de archivo modificado, etc.). Estos bloques:
...
- **AgentShield**: Analiza tu configuración de agentes en busca de vulnerabilidades — `npx scs-agentshield scan`
