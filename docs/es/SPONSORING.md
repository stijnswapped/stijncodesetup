...
SCS se mantiene como un sistema de rendimiento del harness de agentes de código abierto para Claude Code, Cursor, OpenCode y Codex app/CLI.
...
| Growth Partner | $500/mes | Equipos adoptando activamente SCS | Beneficios de Pilot + sincronización mensual de office hours + orientación de integración de flujos de trabajo |
...
- Descargas de npm (`stijncodesetup`, `scs-agentshield`)
...
- GitHub Sponsors: [https://github.com/sponsors/StijnCodeSetup](https://github.com/sponsors/StijnCodeSetup)
- Sitio del proyecto: [https://scs.tools](https://scs.tools)
