...
Gracias a todos los que financian el trabajo de código abierto de SCS. Tu patrocinio es lo que permite que la capa OSS se mantenga gratuita mientras la GitHub App, los análisis de seguridad alojados y las mejoras continuas se publican cada semana.

## Patrocinadores Empresariales — $2,500/mes

*Conviértete en [patrocinador Empresarial](https://github.com/sponsors/StijnCodeSetup) para aparecer aquí.*
...
*[Conviértete en patrocinador Business](https://github.com/sponsors/StijnCodeSetup) para aparecer aquí con logo en el hero del README principal y un caso de estudio trimestral.*
...
*[Conviértete en patrocinador Team](https://github.com/sponsors/StijnCodeSetup) para obtener un logo pequeño y 5 asientos de SCS Pro.*

## Patrocinadores Pro — $50/mes

*[Conviértete en patrocinador Pro](https://github.com/sponsors/StijnCodeSetup) para aparecer aquí con tu nombre en la fila de patrocinadores del README principal.*
...
*[Conviértete en patrocinador Builder](https://github.com/sponsors/StijnCodeSetup) para apoyar el proyecto y aparecer en esta lista + una nota mensual privada de progreso.*

## Supporters — $5/mes

*[Conviértete en Supporter](https://github.com/sponsors/StijnCodeSetup) para respaldar el proyecto con una insignia de perfil y un agradecimiento en nuestras notas de versión.*
...
|  Team | $200 | Lo anterior + pequeño logo de org en el README + 5 asientos de SCS Pro |
...
[**Conviértete en Patrocinador →**](https://github.com/sponsors/StijnCodeSetup)

Para consultas de patrocinio corporativo, colaboraciones personalizadas o integraciones de PR, envía un correo a **[stijn@scs.tools](mailto:stijn@scs.tools)** con el nombre de tu empresa y el nivel deseado. Respondemos rápido — la mayoría de los acuerdos se cierran en 48 horas.
