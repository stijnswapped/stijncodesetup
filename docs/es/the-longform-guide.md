# La Guía Extendida de StijnCodeSetup

![Encabezado: La Guía Extendida de StijnCodeSetup](../../assets/images/longform/01-header.png)

---

> **Prerequisito**: Esta guía se basa en [La Guía Breve de StijnCodeSetup](./the-shortform-guide.md). Lee esa primero si aún no has configurado skills, hooks, subagentes, MCPs y plugins.
...
Todo lo cubierto en las guías breve y extendida está disponible en GitHub: `github.com/StijnCodeSetup/stijncodesetup`
...
He construido estos hooks y están en el repositorio en `github.com/StijnCodeSetup/stijncodesetup/tree/main/hooks/memory-persistence`
...
He construido una skill de aprendizaje continuo que hace esto: `github.com/StijnCodeSetup/stijncodesetup/tree/main/skills/continuous-learning`
...
*Todo lo cubierto en ambas guías está disponible en GitHub en [stijncodesetup](https://github.com/StijnCodeSetup/stijncodesetup)*
