...
SCSはClaude Code、Cursor、OpenCode、Codex app/CLIにまたがるオープンソースのエージェントハーネスパフォーマンスシステムとして維持されています。
...
| グロースパートナー | $500/月 | SCSを積極的に導入するチーム | パイロット特典 + 月次オフィスアワー同期 + ワークフロー統合ガイダンス |
...
- npmダウンロード数（`stijncodesetup`、`scs-agentshield`）
...
- プロジェクトサイト: [https://scs.tools](https://scs.tools)
