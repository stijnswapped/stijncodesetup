...
高度な機能(10k以上のコミット、チーム共有、自動PR)については、[Skill Creator GitHub App](https://github.com/apps/scs-skill-creator)を使用してください:

- インストール: [github.com/apps/scs-skill-creator](https://github.com/apps/scs-skill-creator)
...
*[StijnCodeSetup](https://github.com/StijnCodeSetup/stijncodesetup)の一部*
