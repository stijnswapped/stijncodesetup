...
クレデンシャル、プライベートワークスペースのエクスポート、個人データセット、およびアカウント固有の自動化を再利用可能なSCSアーティファクトから除外する前に、ドライラン計画とローカルキューファイルを好みます。
...
mcp__scheduled-tasks__create_scheduled_task({
  ...
  prompt: "StijnCodeSetup/stijncodesetupのすべてのオープンPRを確認します。各について：CIステータスをチェック、変更を確認、問題にフラグを立てます。メモリに概要を投稿します。",
