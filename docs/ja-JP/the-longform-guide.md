# StijnCodeSetup 長文ガイド

![Header: The Longform Guide to StijnCodeSetup](./assets/images/longform/01-header.png)

---

> **前提条件**: このガイドは[StijnCodeSetup 簡潔ガイド](./the-shortform-guide.md)を基に構成されています。スキル、フック、サブエージェント、MCP、プラグインのセットアップがまだの場合は、先にそちらをお読みください。
...
簡潔ガイドと長文ガイドで取り上げたすべてのものはGitHubで利用可能です：`github.com/StijnCodeSetup/stijncodesetup`
...
*セッションストレージの例 -> <https://github.com/StijnCodeSetup/stijncodesetup/tree/main/examples/sessions>*
...
これらのフックを構築し、リポジトリの`github.com/StijnCodeSetup/stijncodesetup/tree/main/hooks/memory-persistence`に置いています。
...
この機能を実現する継続学習スキルを構築しました：`github.com/StijnCodeSetup/stijncodesetup/tree/main/skills/continuous-learning`
...
*両ガイドで取り上げたすべてのものはGitHubの[stijncodesetup](https://github.com/StijnCodeSetup/stijncodesetup)で利用可能です*
