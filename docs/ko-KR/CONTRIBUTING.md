...
1. 먼저 `skills/your-skill-name/` 아래에 일반적인 SCS 스킬로 추가합니다.
...
- **이슈:** [github.com/StijnCodeSetup/stijncodesetup/issues](https://github.com/StijnCodeSetup/stijncodesetup/issues)
