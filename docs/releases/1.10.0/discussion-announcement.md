...
SCS just crossed **140K stars**, and the public release surface had drifted too far from the actual repo.
...
SCS 2.0 is now **real as an alpha control-plane surface** in-tree under `scs2/`.
...
That does **not** mean the full SCS 2.0 roadmap is done.
...
- SCS 1.x is the battle-tested harness/workflow layer shipping broadly today
- SCS 2.0 is the alpha control-plane growing on top of it
