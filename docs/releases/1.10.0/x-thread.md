# X Thread Draft — SCS v1.10.0

SCS crossed 140K stars and the public surface had drifted too far from the actual repo.
...
SCS 2.0 is no longer just roadmap talk.

the `scs2/` control-plane alpha is in-tree, builds today, and already exposes:
