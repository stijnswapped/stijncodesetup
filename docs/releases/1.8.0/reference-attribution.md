...
SCS v1.8.0 references research and workflow inspiration from:
...
2. SCS implementations are re-authored for this repository’s architecture and licensing model.
