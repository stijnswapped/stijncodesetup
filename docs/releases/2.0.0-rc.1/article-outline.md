# Article Outline - SCS v2.0.0-rc.1

## Working Title

Turning SCS Into a Cross-Harness Operating System
...
- chat, CLI, TUI, cron, and handoffs can sit above the reusable SCS layer
...
- Claude Code remains the core target, but SCS now treats Codex, OpenCode,
...
- AgentShield and SCS Tools work is mirrored into the roadmap so enterprise
