...
This rc.1 note records a public teaser skill pack that connects SCS's skill
distribution loop with Itô prediction-market workflows while keeping the two
businesses separate.

SCS remains the open agent-harness substrate and SCS Tools remains the hosted
GitHub App / Pro surface. Itô remains a separate prediction-market basket
business. The link is distribution: SCS can ship reusable skills that make
...
1. SCS users discover useful public prediction-market skills.
...
5. Sanitized patterns can become new SCS skills.

This sends agent/tooling traffic toward Itô without making SCS Tools look like
