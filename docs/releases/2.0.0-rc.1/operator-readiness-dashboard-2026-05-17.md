...
- `scs-tools-next-level`: complete Marketplace purchase/webhook readback, then run the live announcement gate
...
3. Complete SCS Tools Marketplace purchase/webhook readback, then run preflight and the live announcement gate before publishing native-payments copy.
