# SCS v2.0.0-rc.1 Owner Approval Packet
...
| SCS Tools billing language | defer | live readiness readback for the target account and billing/product state | Do not announce native payments or Marketplace-managed Pro until the gate is live. |
...
| --- | --- | --- |
| GitHub prerelease URL | `gh release view v2.0.0-rc.1 --repo StijnCodeSetup/StijnCodeSetup --json url` | release notes, URL ledger, social copy |
| npm rc package URL | `npm view stijncodesetup@2.0.0-rc.1 name version dist.tarball dist.integrity time --json` | URL ledger, quickstart, release notes |
| Claude plugin tag URL | pushed `scs--v2.0.0-rc.1` tag or marketplace readback | URL ledger, plugin docs, release notes |
...
| SCS Tools billing/readiness URL | live readiness readback or explicit blocked status | sponsor copy, Pro copy, release notes |
