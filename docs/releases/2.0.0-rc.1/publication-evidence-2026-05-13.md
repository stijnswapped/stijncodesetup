# SCS v2.0.0-rc.1 Publication Evidence - 2026-05-13
...
| --- | --- | --- |
| GitHub PRs and issues | `gh pr list` / `gh issue list` across trunk, AgentShield, JARVIS, SCS-Tools, SCS-website | 0 open PRs and 0 open issues across tracked repos |
| Trunk discussions | GraphQL discussion sweep for `StijnCodeSetup/stijncodesetup` | Latest 100 discussions were closed; no open discussion backlog found |
