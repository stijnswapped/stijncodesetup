...
```text
Use the public SCS release pack in the repo:
...
1. Finalize one strong X thread for SCS v2.0.0-rc.1.
2. Finalize one strong LinkedIn post for SCS v2.0.0-rc.1.
3. Give me one 30-60 second Hermes x SCS video script and one 15-30 second variant.
