...
This is the production contract for the SCS 2.0 release video suite. It keeps
...
SCS 2.0 is the harness-native operator system for agentic work.
...
- reusable skills, rules, hooks, agents, MCP conventions, release gates, and
  operator workflows;
- `scs2/` as the alpha control-plane/TUI direction, not the whole product;
- AgentShield and supply-chain gates as the enterprise trust layer;
- OSS stays free, with GitHub Sponsors, SCS Tools Pro, and consulting as the
  funding surface.
...
```bash
SCS_VIDEO_SOURCE_ROOT=/path/to/scs_2_raws \
SCS_VIDEO_RELEASE_SUITE_ROOT=/path/to/scs_2_release_suite \
npm run release:video-suite -- --format json
```

`SCS_VIDEO_SOURCE_ROOT` should contain proof images and may contain an `_edited/`
subdirectory with edited source clips. `SCS_VIDEO_RELEASE_SUITE_ROOT` should
...
| `sf-thread-2-whatisscs.mp4` | What is SCS | category clarity and GitHub App explanation |
...
| --- | ---: | --- | --- |
| Primary launch video | 90-150s | 16:9 | `scs-2-primary-launch.mp4` |
| Install proof clip | 25-35s | 16:9 and 9:16 | `scs-2-install-proof-*` |
| What is SCS clip | 45-60s | 16:9 and 9:16 | `scs-2-what-is-scs-*` |
| Security proof clip | 45-60s | 16:9 and 9:16 | `scs-2-security-proof-*` |
| Money/proof clip | 30-45s | 16:9 and 9:16 | `scs-2-money-proof-*` |
| Coverage/social proof clip | 30-45s | 16:9 and 9:16 | `scs-2-social-proof-*` |
...
| --- | --- | ---: | ---: | --- |
| 01 | `sf-longform-full.mp4` | 161.12 | 177.68 | Cleaner opener: SCS as structured context with skills, commands, agents, hooks, and project setup. |
| 02 | `thread-2-ghapp-money.mp4` | 21.84 | 30.40 | Direct product thesis: agentic harness optimization. |
| 03 | `thread-2-ghapp-money.mp4` | 41.00 | 59.72 | Not another harness; SCS is the layer and tooling on top of harnesses. |
| 04 | `longform-full-wide.mp4` | 254.60 | 271.20 | Agentic IDE, observability, tracing, and multi-agent control-plane direction. |
| 05 | `sf-thread-2-whatisscs.mp4` | 40.08 | 60.60 | GitHub App analyzes repos and injects project-specific skills, prompts, and hooks. |
...
- `renders/scs-2-primary-launch-rough-v1.mp4`
- `renders/scs-2-primary-launch-rough-v1.captions.srt`
...
| Output | Target |
| --- | --- |
| `scs-2-primary-launch.mp4` | 90-150s, 1920x1080, audio |
| `scs-2-primary-launch.captions.srt` | primary captions |
| `scs-2-install-proof-wide.mp4` | 25-35s, 1920x1080, audio |
| `scs-2-install-proof-vertical.mp4` | 25-35s, 1080x1920, audio |
| `scs-2-what-is-scs-wide.mp4` | 45-60s, 1920x1080, audio |
| `scs-2-what-is-scs-vertical.mp4` | 45-60s, 1080x1920, audio |
| `scs-2-security-proof-wide.mp4` | 45-60s, 1920x1080, audio |
| `scs-2-security-proof-vertical.mp4` | 45-60s, 1080x1920, audio |
| `scs-2-money-proof-wide.mp4` | 30-45s, 1920x1080, audio |
| `scs-2-money-proof-vertical.mp4` | 30-45s, 1080x1920, audio |
| `scs-2-social-proof-wide.mp4` | 30-45s, 1920x1080, audio |
| `scs-2-social-proof-vertical.mp4` | 30-45s, 1080x1920, audio |

## video-use compatible workflow

Use the same production shape as Video Use while keeping the SCS-specific media
stack intact:
...
| SCS Tools Pro | billing/product page only after live readback confirms claims |
| AgentShield | CLI output, policy category view, supply-chain gate |
| `scs2/` | alpha control-plane/TUI surface with alpha framing |
...
- first 10 seconds clearly say what SCS is;
