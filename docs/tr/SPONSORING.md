...
SCS, Claude Code, Cursor, OpenCode ve Codex app/CLI genelinde açık kaynaklı bir ajan performans sistemi olarak sürdürülmektedir.
...
| Growth Partner | $500/ay | SCS'yi aktif olarak benimseyen ekipler | Pilot avantajları + aylık ofis saatleri senkronizasyonu + iş akışı entegrasyon rehberliği |
...
- npm indirmeleri (`stijncodesetup`, `scs-agentshield`)
...
- Proje sitesi: [https://scs.tools](https://scs.tools)
