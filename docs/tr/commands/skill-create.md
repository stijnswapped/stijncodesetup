...
Gelişmiş özellikler için (10k+ commit, ekip paylaşımı, otomatik PR'lar), [Skill Creator GitHub App](https://github.com/apps/scs-skill-creator) kullanın:

- Yükle: [github.com/apps/scs-skill-creator](https://github.com/apps/scs-skill-creator)
...
*[StijnCodeSetup](https://github.com/StijnCodeSetup/stijncodesetup)'un bir parçası*
