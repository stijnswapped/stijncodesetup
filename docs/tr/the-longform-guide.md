...
Kısa ve uzun kılavuzlarda ele alınan her şey GitHub'da mevcuttur: `github.com/StijnCodeSetup/stijncodesetup`
...
Bu hook'ları oluşturdum ve repo'da `github.com/StijnCodeSetup/stijncodesetup/tree/main/hooks/memory-persistence` adresindeler
...
Bunu yapan bir sürekli öğrenme skill'i oluşturdum: `github.com/StijnCodeSetup/stijncodesetup/tree/main/skills/continuous-learning`
...
*Her iki kılavuzda ele alınan her şey GitHub'da [stijncodesetup](https://github.com/StijnCodeSetup/stijncodesetup) adresinde mevcuttur*
