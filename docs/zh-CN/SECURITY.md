...
如果您在 SCS 中发现安全漏洞，请负责任地报告。

**请勿为安全漏洞创建公开的 GitHub 议题。**

请将信息发送至 **<security@scs.tools>**，邮件中需包含：
...
* 安装/卸载/修复生命周期脚本
* 随 SCS 分发的 MCP 配置
* AgentShield 安全扫描器 ([github.com/StijnCodeSetup/scs-agentshield](https://github.com/StijnCodeSetup/scs-agentshield))

## 安全资源

* **AgentShield**：扫描您的代理配置以查找漏洞 — `npx scs-agentshield scan`
