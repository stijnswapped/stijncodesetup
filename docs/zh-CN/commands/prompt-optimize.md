---
description: 分析一个草稿提示，输出一个经过优化、富含SCS的版本，准备粘贴并运行。不执行任务——仅输出咨询分析。
---

# /prompt-optimize

分析并优化以下提示语，以实现最大化的SCS杠杆效应。
