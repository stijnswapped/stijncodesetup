...
对于高级功能（10k+ 提交、团队共享、自动 PR），请使用 [Skill Creator GitHub 应用](https://github.com/apps/scs-skill-creator)：

* 安装: [github.com/apps/scs-skill-creator](https://github.com/apps/scs-skill-creator)
...
*属于 [StijnCodeSetup](https://github.com/StijnCodeSetup/stijncodesetup)*
