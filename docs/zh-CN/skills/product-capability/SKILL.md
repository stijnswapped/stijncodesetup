...
description: 将PRD意图、路线图需求或产品讨论转化为可实施的方案计划，在开始多服务工作之前暴露约束、不变性、接口和未解决的决策。当用户需要SCS原生的PRD到SRS通道，而不是模糊的规划文本时使用。
origin: SCS
---
...
* 生成的计划可在Claude Code、Codex、Cursor、OpenCode和SCS 2.0规划界面中复用。
