...
description: 将通知作为统一的 SCS 原生工作流进行操作，涵盖 GitHub、Linear、桌面提醒、钩子以及连接的通信界面。当真正的问题是告警路由、去重、升级或收件箱崩溃时使用。
origin: SCS
---
...
* 当前设置制造了噪音而非行动
* 用户希望将重叠的通知分支或积压提案整合到一个 SCS 原生通道中
