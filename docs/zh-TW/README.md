...
<img src="https://github.com/user-attachments/assets/1a471488-59cc-425b-8345-5245c7efbcef" alt="StijnCodeSetup 簡明指南" />
</a>
</td>
<td width="50%">
<a href="https://x.com/StijnCodeSetup/status/2014040193557471352">
<img src="https://github.com/user-attachments/assets/c9ca43bc-b149-427f-b551-af6840c368f0" alt="StijnCodeSetup 完整指南" />
</a>
</td>
</tr>
<tr>
...
# 複製規則（應用於所有專案）
cp -r stijncodesetup/rules/* ~/.claude/rules/
```
...
[安裝 GitHub App](https://github.com/apps/scs-skill-creator) | [scs.tools](https://scs.tools)
...
# 複製規則
cp stijncodesetup/rules/*.md ~/.claude/rules/
...
如果您是透過 `/plugin install` 安裝 SCS，請不要再把這些鉤子複製到 `settings.json`。Claude Code v2.1+ 會自動載入外掛中的 `hooks/hooks.json`，重複註冊會導致重複執行以及 `${CLAUDE_PLUGIN_ROOT}` 無法解析。
...
- **簡明指南（從這裡開始）：** [StijnCodeSetup 簡明指南](https://x.com/StijnCodeSetup/status/2012378465664745795)
- **完整指南（進階）：** [StijnCodeSetup 完整指南](https://x.com/StijnCodeSetup/status/2014040193557471352)
- **追蹤：** [@StijnCodeSetup](https://x.com/StijnCodeSetup)
