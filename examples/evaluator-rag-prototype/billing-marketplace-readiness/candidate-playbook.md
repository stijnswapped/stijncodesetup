...
Use this playbook when release copy or roadmap text mentions SCS Tools
...
2. Check the current repo and public listing surfaces:
   - `gh api repos/SCS-Tools/SCS-Tools`
   - `https://github.com/marketplace/scs-tools`
...
- `rg -n "billing|Billing|Marketplace|marketplace|subscription|seat|entitlement|plan" README.md docs/releases/2.0.0-rc.1 docs/SCS-2.0-GA-ROADMAP.md`
- `gh api repos/SCS-Tools/SCS-Tools`
- Manual live check of `https://github.com/marketplace/scs-tools`
- `npx --yes markdownlint-cli docs/releases/2.0.0-rc.1/*.md docs/SCS-2.0-GA-ROADMAP.md`
- `git diff --check`
