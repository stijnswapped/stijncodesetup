...
>
> Use the SCS-owned namespace below for user-level Claude installs. Flat
> package-level destinations can collide with non-SCS rule packs and do not
> match the main README guidance.

```bash
# Create the SCS rule namespace once.
...
cp -r rules/angular ~/.claude/rules/scs/
cp -r rules/vue ~/.claude/rules/scs/
cp -r rules/nuxt ~/.claude/rules/scs/
cp -r rules/python ~/.claude/rules/scs/
cp -r rules/golang ~/.claude/rules/scs/
cp -r rules/web ~/.claude/rules/scs/
cp -r rules/react-native ~/.claude/rules/scs/
cp -r rules/swift ~/.claude/rules/scs/
cp -r rules/php ~/.claude/rules/scs/
cp -r rules/ruby ~/.claude/rules/scs/
