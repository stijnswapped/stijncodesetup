...
# Install SCS git safety hooks globally via core.hooksPath.
# Usage:
...
DEST_DIR="${SCS_GLOBAL_HOOKS_DIR:-$HOME/.codex/git-hooks}"
...
log "Installed SCS global git hooks."
log "Disable per repo by creating .scs-hooks-disable in project root."
log "Temporary bypass: SCS_SKIP_PRECOMMIT=1 or SCS_SKIP_PREPUSH=1"
