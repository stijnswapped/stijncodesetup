#!/usr/bin/env node
/**
 * Refactored SCS installer runtime.
 *
...
Targets:
  claude       (default) - Install SCS into ~/.claude/ with managed rules/skills under rules/scs and skills/scs
  claude-project - Install SCS into ./.claude/ (per-project) with managed rules/skills under rules/scs and skills/scs
