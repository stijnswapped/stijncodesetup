...
const ADAPTER_RECORDS = Object.freeze([
  ...
  },
  {
    ...
    unsupported_surfaces: ['No full SCS hook parity; ecosystem ports must document drift from upstream SCS'],
  ...
  },
  {
    ...
    unsupported_surfaces: ['No SCS installer or direct adapter today'],
    ...
    risk_notes: ['Do not import product-specific assumptions; convert lessons into SCS event fields.'],
    last_verified_at: '2026-05-12',
    owner: 'SCS maintainers',
  ...
  },
  {
    ...
    verification_commands: ['`npm run observability:ready`'],
    risk_notes: ['Keep SCS portable; do not require a desktop workspace to get basic value.'],
    last_verified_at: '2026-05-12',
    owner: 'SCS maintainers',
    source_docs: ['docs/architecture/cross-harness.md'],
  },
