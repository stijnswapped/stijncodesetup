...
const DEFAULT_INSTALL_CONFIG = 'scs-install.json';
const CONFIG_SCHEMA_PATH = path.join(__dirname, '..', '..', '..', 'schemas', 'scs-install-config.schema.json');
...
function getValidator() {
  ...
  const schema = readJson(CONFIG_SCHEMA_PATH, 'scs-install-config.schema.json');
