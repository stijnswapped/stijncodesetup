...
/**
 * SCS agent data root for memory persistence and related state.
 * Defaults to ~/.claude; override with SCS_AGENT_DATA_HOME (e.g. ~/.cursor/scs).
 */
...
/** Get the canonical SCS sessions directory ($SCS_AGENT_DATA_HOME/session-data) */
export function getSessionsDir(): string;

/** Get the legacy sessions directory ($SCS_AGENT_DATA_HOME/sessions) */
...
/** Get the learned skills directory ($SCS_AGENT_DATA_HOME/skills/learned) */
