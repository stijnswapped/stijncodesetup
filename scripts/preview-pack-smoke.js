...
const SCHEMA_VERSION = 'scs.preview-pack-smoke.v1';
...
const HERMES_BOUNDARY_MARKERS = [
  ...
  'SCS v2.0.0-rc.1 documents the Hermes surface',
...
function usage() {
  console.log([
    ...
    '',
    'Deterministic smoke gate for the SCS 2.0 rc.1 preview pack.',
    '',
    'Options:',
