...
const SCHEMA_VERSION = 'scs.release-approval-gate.v1';
...
const REQUIRED_DECISIONS = [
  ...
  {
    id: 'scs-tools-billing-language',
    label: 'SCS Tools billing language',
  },
  {
    id: 'video-upload',
    label: 'Video upload',
...
const REQUIRED_URL_SURFACES = [
  {
    ...
    exampleUrl: 'https://github.com/StijnCodeSetup/StijnCodeSetup/releases/tag/v2.0.0-rc.1',
  },
  {
    id: 'npm-rc-package-url',
    label: 'npm rc package URL',
    exampleUrl: 'https://www.npmjs.com/package/stijncodesetup/v/2.0.0-rc.1',
  },
  {
    id: 'claude-plugin-tag-url',
    label: 'Claude plugin tag URL',
    exampleUrl: 'https://github.com/StijnCodeSetup/StijnCodeSetup/releases/tag/scs--v2.0.0-rc.1',
  },
  {
    id: 'codex-repo-marketplace-evidence',
    label: 'Codex repo-marketplace evidence',
    exampleUrl: 'https://github.com/StijnCodeSetup/StijnCodeSetup/tree/v2.0.0-rc.1/.codex-plugin',
  },
  {
    id: 'primary-launch-video-url',
    label: 'Primary launch video URL',
    exampleUrl: 'https://x.com/StijnCodeSetup/status/0000000000000000000',
  },
  {
    id: 'short-clip-urls',
    label: 'Short clip URLs',
    exampleUrl: 'https://x.com/StijnCodeSetup/status/0000000000000000001',
  },
  {
    id: 'scs-tools-billing-readiness-url',
    label: 'SCS Tools billing/readiness URL',
    exampleUrl: 'https://github.com/SCS-Tools',
  },
];
