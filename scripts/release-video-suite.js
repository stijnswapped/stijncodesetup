...
const SCHEMA_VERSION = 'scs.release-video-suite.v1';
const HYPERGROWTH_DOC_PATH = 'docs/releases/2.0.0/scs-2-hypergrowth-release-command-center.md';
...
const REQUIRED_SOURCE_ASSETS = [
  ...
  {
    id: 'what-is-scs-wide',
    file: 'sf-thread-2-whatisscs.mp4',
    lane: 'what-is-scs',
...
const REQUIRED_SUITE_ARTIFACTS = [
  ...
  },
  {
    ...
    relativePath: 'renders/scs-2-primary-launch-rough-v1.captions.srt',
    kind: 'captions',
  },
  {
    id: 'primary-render-v1',
    relativePath: 'renders/scs-2-primary-launch-rough-v1.mp4',
    kind: 'video',
...
const REQUIRED_PUBLISH_CANDIDATES = [
  {
    ...
    relativePath: 'renders/publish-candidates/scs-2-primary-launch.mp4',
    kind: 'video',
    minDurationSeconds: 90,
    maxDurationSeconds: 150,
    minWidth: 1920,
  ...
  },
  {
    ...
    relativePath: 'renders/publish-candidates/scs-2-primary-launch.captions.srt',
    kind: 'captions',
  },
  {
    id: 'publish-install-proof-wide',
    relativePath: 'renders/publish-candidates/scs-2-install-proof-wide.mp4',
    kind: 'video',
  ...
  },
  {
    ...
    relativePath: 'renders/publish-candidates/scs-2-install-proof-vertical.mp4',
    kind: 'video',
    minDurationSeconds: 25,
    maxDurationSeconds: 35,
    minWidth: 1080,
  ...
  {
    id: 'publish-what-is-scs-wide',
    relativePath: 'renders/publish-candidates/scs-2-what-is-scs-wide.mp4',
    kind: 'video',
  ...
  {
    id: 'publish-what-is-scs-vertical',
    relativePath: 'renders/publish-candidates/scs-2-what-is-scs-vertical.mp4',
    kind: 'video',
    minDurationSeconds: 45,
    maxDurationSeconds: 60,
    minWidth: 1080,
  ...
  },
  {
    ...
    relativePath: 'renders/publish-candidates/scs-2-security-proof-wide.mp4',
    kind: 'video',
    minDurationSeconds: 45,
    maxDurationSeconds: 60,
    minWidth: 1920,
  ...
  },
  {
    ...
    relativePath: 'renders/publish-candidates/scs-2-security-proof-vertical.mp4',
    kind: 'video',
    minDurationSeconds: 45,
    maxDurationSeconds: 60,
    minWidth: 1080,
  ...
  },
  {
    ...
    relativePath: 'renders/publish-candidates/scs-2-money-proof-wide.mp4',
    kind: 'video',
  ...
  },
  {
    ...
    relativePath: 'renders/publish-candidates/scs-2-money-proof-vertical.mp4',
    kind: 'video',
    minDurationSeconds: 30,
    maxDurationSeconds: 45,
    minWidth: 1080,
  ...
  },
  {
    ...
    relativePath: 'renders/publish-candidates/scs-2-social-proof-wide.mp4',
    kind: 'video',
    minDurationSeconds: 30,
    maxDurationSeconds: 45,
    minWidth: 1920,
  ...
  },
  {
    ...
    relativePath: 'renders/publish-candidates/scs-2-social-proof-vertical.mp4',
    kind: 'video',
    minDurationSeconds: 30,
    maxDurationSeconds: 45,
    minWidth: 1080,
...
function usage() {
  console.log([
    ...
    '',
    'Validates the SCS 2.0 release video production lane for the package.json release version without committing raw media paths.',
    '',
    'Options:',
    '  --format <text|json>     Output format (default: text)',
    '  --json                   Alias for --format json',
    '  --root <dir>             Repository root to inspect (default: cwd)',
    '  --source-root <dir>      Directory containing SCS 2 source media, with optional _edited subdir',
...
function parseArgs(argv) {
  ...
  const parsed = {
    ...
    sourceRoot: process.env.SCS_VIDEO_SOURCE_ROOT || '',
    suiteRoot: process.env.SCS_VIDEO_RELEASE_SUITE_ROOT || '',
    skipProbe: false,
    summary: false,
  };
...
function buildReport(options = {}) {
  ...
  const checks = [
    ...
    makeCheck(
      ...
      'Set SCS_VIDEO_SOURCE_ROOT or pass --source-root to the edited SCS 2 media directory.',
      {
    ...
    makeCheck(
      ...
      'Set SCS_VIDEO_RELEASE_SUITE_ROOT or pass --suite-root to the SCS 2 release suite workspace.',
      {
  ...
  if (!sourceRoot) {
    topActions.push('Set SCS_VIDEO_SOURCE_ROOT to the edited SCS 2 media directory.');
  }

  if (!suiteRoot) {
    topActions.push('Set SCS_VIDEO_RELEASE_SUITE_ROOT to the local release suite workspace.');
  }
...
function renderText(report) {
  const lines = [
    `SCS ${report.release} release video suite`,
