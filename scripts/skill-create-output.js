...
class SkillCreateOutput {
  ...
  header() {
    ...
    console.log(chalk.bold(chalk.magenta('║')) + chalk.bold('  SCS Skill Creator                                             ') + chalk.bold(chalk.magenta('║')));
...
`));
  ...
  footer() {
    ...
    console.log(chalk.dim(`  Powered by StijnCodeSetup • scs.tools`));
    console.log(chalk.dim(`  GitHub App: github.com/apps/scs-skill-creator`));
    console.log('\n');
  }
}
