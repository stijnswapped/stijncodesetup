#!/usr/bin/env python3
"""
SCS Dashboard - StijnCodeSetup GUI
Cross-platform TkInter application for managing SCS components
"""
...
from scripts.lib.scs_dashboard_runtime import launch_terminal, maximize_window

logger = logging.getLogger(__name__)

# ============================================================================
# DATA LOADERS - Load SCS data from the project
# ============================================================================

def get_project_path() -> str:
    """Get the SCS project path - assumes this script is run from the project dir"""
...
class SCSDashboard(tk.Tk):
    """Main SCS Dashboard Application"""
    
    def __init__(self):
        super().__init__()
        
        self.project_path = get_project_path()
        self.title("SCS Dashboard - StijnCodeSetup")
        
        maximize_window(self)
        
        try:
            self.icon_image = tk.PhotoImage(file='assets/images/scs-logo.png')
    ...
    def create_widgets(self):
        ...
        try:
            self.logo_image = tk.PhotoImage(file='assets/images/scs-logo.png')
        ...
        self.title_label = ttk.Label(header_frame, text="SCS Dashboard", font=('Open Sans', 18, 'bold'))
...
Usage: This skill is automatically activated when working with related technologies."""
    ...
    def create_settings_tab(self):
        ...
        about_text = """SCS Dashboard v1.0.0
StijnCodeSetup GUI

A cross-platform desktop application for 
managing and exploring SCS components.

Version: 1.10.0
Project: github.com/StijnCodeSetup/stijncodesetup"""
