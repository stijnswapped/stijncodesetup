...
| Feature | v2.0 | v2.1 |
|---------|------|------|
| Storage | Global (`~/.claude/homunculus/`) | Project-scoped (`${XDG_DATA_HOME:-~/.local/share}/scs-homunculus/projects/<hash>/`) |
...
Each project gets a 12-character hash ID (e.g., `a1b2c3d4e5f6`). A registry file at `${XDG_DATA_HOME:-~/.local/share}/scs-homunculus/projects.json` maps IDs to human-readable names.
...
2. `$XDG_DATA_HOME/scs-homunculus`
3. `$HOME/.local/share/scs-homunculus`
...
```bash
# Global directories
mkdir -p "${XDG_DATA_HOME:-$HOME/.local/share}/scs-homunculus"/{instincts/{personal,inherited},evolved/{agents,skills,commands},projects}
...
```
${XDG_DATA_HOME:-~/.local/share}/scs-homunculus/
...
- [SCS-Tools GitHub App](https://github.com/apps/scs-tools) - Generate instincts from repo history
- Homunculus - Community project that inspired the v2 instinct-based architecture (atomic observations, confidence scoring, instinct evolution pipeline)
- [The Longform Guide](https://x.com/StijnCodeSetup/status/2014040193557471352) - Continuous learning section
