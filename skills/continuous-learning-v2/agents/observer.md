...
- Project: `${XDG_DATA_HOME:-~/.local/share}/scs-homunculus/projects/<project-hash>/observations.jsonl`
- Global fallback: `${XDG_DATA_HOME:-~/.local/share}/scs-homunculus/observations.jsonl`
...
- Project: `${XDG_DATA_HOME:-~/.local/share}/scs-homunculus/projects/<project-hash>/instincts/personal/`
- Global: `${XDG_DATA_HOME:-~/.local/share}/scs-homunculus/instincts/personal/` (for universal patterns)
