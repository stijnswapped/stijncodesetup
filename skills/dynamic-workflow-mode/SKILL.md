...
If the repo has SCS2 state enabled, prefer adding or reading checkpoints through the SCS control pane or state-store-backed scripts instead of scattering untracked notes.
