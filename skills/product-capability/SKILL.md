...
description: Translate PRD intent, roadmap asks, or product discussions into an implementation-ready capability plan that exposes constraints, invariants, interfaces, and unresolved decisions before multi-service work starts. Use when the user needs an SCS-native PRD-to-SRS lane instead of vague planning prose.
metadata:
  origin: SCS
---
...
If useful, point to the next SCS-native lane:
...
HANDOFF
- what should happen next and which SCS lane should take it
```
...
- The resulting plan is reusable across Claude Code, Codex, Cursor, OpenCode, and SCS 2.0 planning surfaces.
