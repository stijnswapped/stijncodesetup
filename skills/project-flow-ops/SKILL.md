...
| Port/Rebuild | useful idea, but should be manually re-landed inside SCS |
...
- External-source features should be rebuilt inside SCS when they are valuable but not self-contained
...
- "Map GitHub issues into our SCS 1.x and SCS 2.0 program lanes"
