...
description: >-
  Analyze raw prompts, identify intent and gaps, match SCS components
...
Analyze a draft prompt, critique it, match it to SCS ecosystem components,
...
- User says "how should I use SCS for..."
...
- User is asking about SCS configuration (use `configure-scs` instead)
...
### Phase 3: SCS Component Matching

Map intent + scope + tech stack (from Phase 0) to specific SCS components.
...
### Section 2: Recommended SCS Components
...
A compact version for experienced SCS users. Vary by intent type:
...
- "Optimize this prompt for SCS"
- "Rewrite this prompt so Claude Code uses the right commands"
- "帮我优化这个指令"
- "How should I prompt SCS for this task?"
...
|-----------|------------------|
| `configure-scs` | User hasn't set up SCS yet |
