...
description: Reviews animation and motion code against a high craft bar derived from Stijn design engineering philosophy. Default to flagging; approval is earned.
...
The substantive bar comes from Stijn animation philosophy (animations.dev). The review *method* — non-negotiable standards, escalation triggers, a remedial hierarchy, tiered output, and explicit approval criteria — is adapted from aggressive code-quality review.
