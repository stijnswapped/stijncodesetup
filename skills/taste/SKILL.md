...
## The Pipeline — mixing the SCS video skills

This skill is the conductor. Each SCS skill is an instrument. Do not skip layers.
...
| Step | SCS skill to load | What it does here |
|------|-------------------|-------------------|
