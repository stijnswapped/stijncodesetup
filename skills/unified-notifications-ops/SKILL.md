...
description: Operate notifications as one SCS-native workflow across GitHub, Linear, desktop alerts, hooks, and connected communication surfaces. Use when the real problem is alert routing, deduplication, escalation, or inbox collapse.
metadata:
  origin: SCS
---
...
- the user wants to consolidate overlapping notification branches or backlog proposals into one SCS-native lane
...
Prefer SCS-native orchestration over telling the user to adopt a separate notification product.
...
Call out what SCS already owns.
...
### 4. Design the SCS-native workflow
...
If SCS already has the primitive, prefer:
...
- "Collapse overlapping notification PR ideas into one canonical SCS lane"
