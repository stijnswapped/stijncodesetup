...
if (!fs.existsSync(promptDir) || !fs.existsSync(path.join(repoRoot, '.github', 'copilot-instructions.md'))) {
  console.log('  - skipped: .github Copilot metadata is not present in this stripped repository');
  process.exit(0);
}
