...
function inTempRepo(fn) {
  ...
  try {
    ...
    spawnSync('git', ['config', 'user.name', 'SCS Test'], { cwd: repoDir, stdio: 'pipe', encoding: 'utf8' });
    spawnSync('git', ['config', 'user.email', 'scs@example.com'], { cwd: repoDir, stdio: 'pipe', encoding: 'utf8' });
