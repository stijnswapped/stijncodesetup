/**
 * Tests for scripts/hooks/scs-statusline.js
 *
 * Run with: node tests/hooks/scs-statusline.test.js
 */
...
const { formatDuration, buildContextBar, readCurrentTask } = require('../../scripts/hooks/scs-statusline');
...
function makeTempConfig() {
  return fs.mkdtempSync(path.join(os.tmpdir(), 'scs-statusline-test-'));
}

function runTests() {
  console.log('\n=== Testing scs-statusline.js ===\n');
