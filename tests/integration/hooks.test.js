...
function runHookWithInput(scriptPath, input = {}, env = {}, timeoutMs = 10000) {
  return new Promise((resolve, reject) => {
    ...
    if (!Object.prototype.hasOwnProperty.call(env, 'SCS_AGENT_DATA_HOME')) {
      delete mergedEnv.SCS_AGENT_DATA_HOME;
    }
...
function getTestHomunculusEnv(testDir) {
  ...
  return {
    ...
    homunculusDir: path.join(xdgDataHome, 'scs-homunculus'),
  };
}
    ...
    try {
      ...
      const result = await runHookWithInput(
        ...
        {},
        {
          ...
          USERPROFILE: homunculusEnv.HOME,
          XDG_DATA_HOME: homunculusEnv.XDG_DATA_HOME,
          CLAUDE_PROJECT_DIR: projectDir,
          SCS_AGENT_DATA_HOME: path.join(testDir, '.claude')
        }
      );
