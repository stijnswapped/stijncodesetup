...
if (args[0] === 'pr' && args[1] === 'list') {
  if (mode === 'empty') write([]);
  else write([
    {
      ...
      url: 'https://github.com/stijnswapped/stijncodesetup/pull/3',
    ...
    },
    {
      ...
      url: 'https://github.com/stijnswapped/stijncodesetup/pull/4',
  ...
  if (mode === 'empty') write([]);
  else write([
    {
      ...
      url: 'https://github.com/stijnswapped/stijncodesetup/issues/9',
  ...
  if (await test('tracks linked work items for Linear, GitHub, and handoff progress', async () => {
    ...
    try {
      ...
      store.upsertWorkItem({
        ...
        status: 'merged',
        priority: 'normal',
        url: 'https://github.com/stijnswapped/stijncodesetup/pull/1738',
        owner: 'maintainer',
