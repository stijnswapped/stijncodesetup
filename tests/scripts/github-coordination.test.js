    ...
    await test('claims an epic issue, updates GitHub state, and caches a work item', async () => {
      ...
      try {
        ...
        const issueView = {
          ...
          body: epicBody,
          url: 'https://github.com/stijnswapped/stijncodesetup/issues/12',
          state: 'OPEN',
          labels: [{ name: 'epic' }],
    ...
    await test('unblocks an epic when dependencies are closed', async () => {
      ...
      try {
        ...
        const openIssue = {
          ...
          body: blockedBody,
          url: 'https://github.com/stijnswapped/stijncodesetup/issues/1',
          state: 'OPEN',
        ...
        const closedDependency = {
          ...
          url: 'https://github.com/stijnswapped/stijncodesetup/issues/2',
          state: 'CLOSED',
