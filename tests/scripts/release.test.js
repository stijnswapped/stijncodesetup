...
if (!fs.existsSync(releaseWorkflowPath) || !fs.existsSync(reusableReleaseWorkflowPath) || !fs.existsSync(ciWorkflowPath)) {
  console.log('\n=== Testing release.sh ===\n');
  console.log('  - skipped: .github release workflow metadata is not present in this stripped repository');
  process.exit(0);
}
