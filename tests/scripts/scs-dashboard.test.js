/**
 * Behavioral tests for scs_dashboard.py helper functions.
 */
...
const runtimeHelpersPath = path.join(repoRoot, 'scripts', 'lib', 'scs_dashboard_runtime.py');
...
spec = importlib.util.spec_from_file_location("scs_dashboard_runtime", r"""${runtimeHelpersPath}""")
...
spec.loader.exec_module(module)
try:
    module.launch_terminal('/definitely/not/a/real/scs/path')
