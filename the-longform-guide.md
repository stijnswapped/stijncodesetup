# The Longform Guide to StijnCodeSetup

![Header: The Longform Guide to StijnCodeSetup](./assets/images/longform/01-header.png)

---

> **Prerequisite**: This guide builds on [The Shorthand Guide to StijnCodeSetup](./the-shortform-guide.md). Read that first if you haven't set up skills, hooks, subagents, MCPs, and plugins.
...
Everything covered in the shorthand and longform guides is available on GitHub: `github.com/StijnCodeSetup/stijncodesetup`
...
I've built these hooks and they're in the repo at `github.com/StijnCodeSetup/stijncodesetup/tree/main/hooks/memory-persistence`
...
I've built a continuous learning skill that does this: `github.com/StijnCodeSetup/stijncodesetup/tree/main/skills/continuous-learning`
...
*Everything covered in both guides is available on GitHub at [stijncodesetup](https://github.com/StijnCodeSetup/stijncodesetup)*
