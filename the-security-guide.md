...
_stijncodesetup / research / security_

---

It's been a while since my last article now. Spent time working on building out the SCS devtooling ecosystem. One of the few hot but important topics during that stretch has been agent security.

Widespread adoption of open source agents is here. OpenClaw and others run about your computer. Continuous run harnesses like Claude Code and Codex (using SCS) increase the surface area; and on February 25, 2026, Check Point Research published a Claude Code disclosure that should have ended the "this could happen but won't / is overblown" phase of the conversation for good. With the tooling reaching critical mass, the gravity of exploits multiplies.
...
And if you are using SCS specifically, this is also the problem space I built AgentShield for: suspicious hooks, hidden prompt injection patterns, over-broad permissions, risky MCP config, secret exposure, and the stuff people absolutely will miss in manual review.
...
Scan your setup: [github.com/StijnCodeSetup/scs-agentshield](https://github.com/StijnCodeSetup/scs-agentshield)
...
> [The Shorthand Guide to StijnCodeSetup](https://x.com/StijnCodeSetup/status/2012378465664745795)
>
> [The Longform Guide to StijnCodeSetup](https://x.com/StijnCodeSetup/status/2014040193557471352)

go do that and also save these repos:
- [github.com/StijnCodeSetup/stijncodesetup](https://github.com/StijnCodeSetup/stijncodesetup)
- [github.com/StijnCodeSetup/scs-agentshield](https://github.com/StijnCodeSetup/scs-agentshield)
