# The Shorthand Guide to StijnCodeSetup
...
SCS still ships a `commands/` layer, but it is best thought of as legacy slash-entry compatibility during migration. The durable logic should live in skills.
